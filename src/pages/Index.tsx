    ...
    <div className="min-h-screen bg-background animate-fade-in">
      ...
      <main>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Newsletter Section */}
          <section className="my-20 rounded-2xl honey-gradient p-12 md:p-16 text-center animate-scale-in">
            <div className="max-w-2xl mx-auto space-y-8">
              <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white">Stay Sweet.</h2>
              <p className="text-xl text-white/80 leading-relaxed">
                Subscribe to receive our latest updates, recipes, and honey-inspired stories.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  type="email"
                  placeholder="Your email"
                  className="flex-1 px-6 py-4 rounded-full border-0 bg-white/20 backdrop-blur-sm text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-white/50 transition-all"
                />
                <button className="px-10 py-4 rounded-full bg-white text-[hsl(var(--honey-amber))] font-bold hover:bg-white/90 hover:scale-105 transition-all">
                  Subscribe
                </button>
              </div>
            </div>
